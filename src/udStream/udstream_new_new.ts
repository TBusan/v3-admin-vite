...
let SupportedFileTypesSceneItems: string[] = []
function fillSupportedFileTypesSceneItems(pJSON: number) {
  let SupportedFileTypesSceneItemsStrJSON = globalThis.UTF8ToString(pJSON)
  SupportedFileTypesSceneItems = JSON.parse(SupportedFileTypesSceneItemsStrJSON)
}

export async function GetSupportedFileTypesSceneItems() {
  if (SupportedFileTypesSceneItems.length != 0) {
    return SupportedFileTypesSceneItems
  } else {
    return new Promise<string[]>((resolve) => {
      let callback = (pJSON: number) => {
        globalThis.Module.removeFunction(callbackPtr)
        fillSupportedFileTypesSceneItems(pJSON)
        resolve(SupportedFileTypesSceneItems)
      }
      let callbackPtr = globalThis.Module.addFunction(callback, "vi")
      globalThis.Module.ccall("vcJavascriptHooks_GetSupportedFileTypesSceneItems", undefined, ["int"], [callbackPtr])
    })
  }
}
...
function openModalBaseCallback(type: number) {
  if (openModalCallback) return openModalCallback(type)
  return 0
}
...
//   if (userGuidePageChangeCallback) userGuidePageChangeCallback(globalThis.UTF8ToString(pagePtr), forceReload != 0)
// }
...
type GeneralPlaceLayerCallbackType = (jsonStr: string) => void
let generalPlaceLayerPickCallback: GeneralPlaceLayerCallbackType | undefined = undefined
function generalPlaceLayerPickBaseCallback(pJSON: number) {
  if (generalPlaceLayerPickCallback) {
    let jsonStr = globalThis.UTF8ToString(pJSON)
    generalPlaceLayerPickCallback(jsonStr)
  }
}
...
type getCollabMessageCallbackType = (
  messageType: string,
...
function getCollabMessageBaseCallback(
  messageTypePtr: number,
  messageSenderPtr: number,
  messageIndex: number,
  senderIndex: number
) {
  if (getCollabMessageCallback) {
    getCollabMessageCallback(
      globalThis.UTF8ToString(messageTypePtr),
      globalThis.UTF8ToString(messageSenderPtr),
      messageIndex,
      senderIndex
    )
  }
...
export function registerCallbacks() {
  if (!registered) {
    var callbackPtr = globalThis.Module.addFunction(langChangeCallback, "vi")
    ...
    //   "vcJavascriptHooks_RegisterUserGuidePageChangeCallback",
    //   undefined,
    //   ["number"],
    //   [callbackPtr]
    // )
    ...
    callbackPtr = globalThis.Module.addFunction(generalPlaceLayerPickBaseCallback, "vi")
    globalThis.Module.ccall(
      "vcJavascriptHooks_RegisterGeneralPlaceLayerPickCallback",
      undefined,
      ["number"],
      [callbackPtr]
    )
    ...
    globalThis.Module.ccall(
      "vcJavascriptHooks_RegisterGet2DProfileUpdateCallback",
      undefined,
      ["number"],
      [callbackPtr]
    )
    ...
    globalThis.Module.ccall(
      "vcJavascriptHooks_RegisterGetFlyThroughAllNodesDataCallback",
      undefined,
      ["number"],
      [callbackPtr]
    )
...
export function registerPlaceLayerPickingCallback(callback: GeneralPlaceLayerCallbackType) {
  if (generalPlaceLayerPickCallback != callback) {
    generalPlaceLayerPickCallback = callback
  }
}
...
export function loadSceneItem(uri: string, autoFly: boolean) {
  if (autoFly) {
...
export function restoreDefaultWKT() {
  return new Promise<void>((resolve) => {
    ...
    globalThis.Module.ccall("vcJavascriptHooks_RestoreDefaultWKT", undefined, ["int"], [callbackPtr])
  })
}
...
type loginV2ApproveCodeCallbackType = (approveCode: string) => void
export function Loginv2(callback: loginV2CallbackType, approveCodeCallback: loginV2ApproveCodeCallbackType) {
  let callbackPtr = 0
  if (callback) callbackPtr = globalThis.Module.addFunction(callback, "vi")

  let approveCodeCallbackPtr = 0
  if (approveCodeCallback) {
    let approveCodeStringifyCallback = (approveCodePtr: number) => {
      approveCodeCallback(globalThis.UTF8ToString(approveCodePtr))
    }
    approveCodeCallbackPtr = globalThis.Module.addFunction(approveCodeStringifyCallback, "vi")
  }

  globalThis.Module.ccall("vcJavascriptHooks_Loginv2", undefined, ["int", "int"], [callbackPtr, approveCodeCallbackPtr])
}
...
export function setActiveTool(tool: ActiveTool, clearSelection: boolean = true) {
  globalThis.Module.ccall("vcJavascriptHooks_SetActiveTool", undefined, ["int", "int"], [tool, clearSelection ? 1 : 0])
}

export function deactivateKeyBindings(deactivateKeyBindings: boolean = true) {
  return new Promise<void>((resolve) => {
    let callback = () => {
      globalThis.Module.removeFunction(callbackPtr)
      resolve()
...
export function faceCameraToNorth() {
  globalThis.Module.ccall("vcJavascriptHooks_FaceCameraToNorth", undefined, [], [])
}
...
export function startRecordFlyThrough(node: ProjectNode) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_StartRecordFlyThrough",
      undefined,
      ["int", "int"],
      [callbackPtr, node.projectNodePtr]
    )
...
export function stopRecordFlyThrough(node: ProjectNode) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_StopRecordFlyThrough",
      undefined,
      ["int", "int"],
      [callbackPtr, node.projectNodePtr]
    )
...
export function playFlyThroughRecording(node: ProjectNode, timePosition: number) {
  return new Promise<void>((resolve) => {
    ...
    globalThis.Module.ccall(
      ...
      undefined,
      ["int", "int", "number"],
      [callbackPtr, node.projectNodePtr, timePosition]
    )
  })
}
...
export function stopPlayFlyThrough(node: ProjectNode) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_StopPlayFlyThrough",
      undefined,
      ["int", "int"],
      [callbackPtr, node.projectNodePtr]
    )
...
export function setFlyThroughInfo(node: ProjectNode, data: Object) {
  return new Promise<void>((resolve) => {
    ...
    globalThis.Module.ccall(
      ...
      undefined,
      ["int", "string", "int"],
      [callbackPtr, JSON.stringify(data), node.projectNodePtr]
    )
  })
}
...
export function resetSceneItemTransforms(node: ProjectNode) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_ResetSceneItemTransforms",
      undefined,
      ["int", "int"],
      [callbackPtr, node.projectNodePtr]
    )
...
export function updateMovementVector(x: number, y: number, z: number) {
  globalThis.Module.ccall(
    "vcJavascriptHooks_UpdateMovementVector",
    undefined,
    ["number", "number", "number"],
    [x, y, z]
  )
...
export function generate2DProfile(node: ProjectNode) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_Generate2DProfile",
      undefined,
      ["int", "int"],
      [callbackPtr, node.projectNodePtr]
    )
...
export function collabRequestFollow(sessionID: string) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_CollabRequestFollow",
      undefined,
      ["int", "string"],
      [callbackPtr, sessionID]
    )
  })
}
...
export function collabMoveTo(x: number, y: number, z: number, heading: number, pitch: number) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_CollabMoveTo",
      undefined,
      ["int", "number", "number", "number", "number", "number"],
      [callbackPtr, x, y, z, heading, pitch]
    )
  })
}
...
export function collabAccept(messageIndex: number, senderIndex: number) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_CollabAccept",
      undefined,
      ["int", "number", "number"],
      [callbackPtr, messageIndex, senderIndex]
    )
  })
}
...
export function collabDecline(messageIndex: number) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_CollabDecline",
      undefined,
      ["int", "number"],
      [callbackPtr, messageIndex]
    )
  })
}
...
export function isSceneItemLoaded(node: ProjectNode) {
  return new Promise<Boolean>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "vi")
    globalThis.Module.ccall(
      "vcJavascriptHooks_IsSceneItemLoaded",
      undefined,
      ["int", "int"],
      [callbackPtr, node.projectNodePtr]
    )
...
export function canUseProjection(node: ProjectNode) {
  return new Promise<Boolean>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "vi")
    globalThis.Module.ccall(
      "vcJavascriptHooks_SceneItemCanUseProjection",
      undefined,
      ["int", "int"],
      [callbackPtr, node.projectNodePtr]
    )
...
export function useSceneItemProjection(node: ProjectNode) {
  return new Promise<void>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "v")
    globalThis.Module.ccall(
      "vcJavascriptHooks_UseSceneItemProjection",
      undefined,
      ["int", "int"],
      [callbackPtr, node.projectNodePtr]
    )
...
export function advancedMeasurement(points: Array<number>, nodePtr: number, pMask: string) {
  return new Promise<any>((resolve) => {
    ...
    globalThis.Module.ccall(
      "vcJavascriptHooks_AdvancedMeasurement",
      undefined,
      ["number", "number", "number", "number", "string", "int"],
      [points[0], points[1], points[2], nodePtr, pMask, callbackPtr]
    )
  })
}
...
export function setNodesToGetScreenCoords(uuids: Array<string>) {
  return new Promise<any>((resolve) => {
    let callback = (nodeptr: number, x: number, y: number, z: number) => {
      globalThis.Module.removeFunction(callbackPtr)
      resolve([nodeptr, x, y, z])
    }
    let callbackPtr = globalThis.Module.addFunction(callback, "vifff")
    globalThis.Module.ccall(
      "vcJavascriptHooks_SetNodesToGetScreenCoords",
      undefined,
      ["string", "int"],
      [JSON.stringify(uuids), callbackPtr]
    )
  })
}
// using vcJavascriptHooksSagMeasurementCallback = void(double distance);
// udSceneNode* pUdsNode, double fromX, double fromY, double fromZ, double toX, double toY, double toZ, const char* pMasks, vcJavascriptHooksSagMeasurementCallback* pCallback
// type sagMeasurementCallback = (distance: number) => void;
export function sagMeasurement(nodePtr: number, pt0: Array<number>, pt1: Array<number>, masks: string) {
  return new Promise<any>((resolve) => {
    let callback = (distance: number) => {
      globalThis.Module.removeFunction(callbackPtr)
      resolve(distance)
    }
    let callbackPtr = globalThis.Module.addFunction(callback, "vf")
    globalThis.Module.ccall(
      "vcJavascriptHooks_SagMeasurement",
      undefined,
      ["number", "number", "number", "number", "number", "number", "number", "string", "int"],
      [nodePtr, pt0[0], pt0[1], pt0[2], pt1[0], pt1[1], pt1[2], masks, callbackPtr]
    )
  })
}

export function setColorByHeightScheme(json: Array<any>) {
  globalThis.Module.ccall("vcJavascriptHooks_SetColorByHeightScheme", undefined, ["string"], [JSON.stringify(json)])
}
...
export function getNearestUds(point: number[]) {
  return new Promise<any>((resolve) => {
    ...
    let callbackPtr = globalThis.Module.addFunction(callback, "vi")
    globalThis.Module.ccall(
      "vcJavascriptHooks_GetNearestUds",
      undefined,
      ["number", "number", "number", "int"],
      [point[0], point[1], point[2], callbackPtr]
    )
  })
}
...
export function visibleTest(nodePtr: number, pt0: number[], pt1: number[]) {
  return new Promise<any>((resolve) => {
    let callback = (visible: number, dist: number) => {
      globalThis.Module.removeFunction(callbackPtr)
      resolve([visible, dist])
    }
    let callbackPtr = globalThis.Module.addFunction(callback, "vif")
    globalThis.Module.ccall(
      "vcJavaScriptHooks_VisibleTest",
      undefined,
      ["number", "number", "number", "number", "number", "number", "number", "int"],
      [nodePtr, pt0[0], pt0[1], pt0[2], pt1[0], pt1[1], pt1[2], callbackPtr]
    )
  })
}
...
export function createPlaceLayer(obj: object) {
  let str = JSON.stringify(obj)
  globalThis.Module.ccall("vcJavaScriptHooks_CreatePlaceLayer", undefined, ["string"], [str])
}
